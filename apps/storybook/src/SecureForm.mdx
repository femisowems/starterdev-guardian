...
<table className="gf-docs-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Proprietary but not personally identifiable.</td>
    </tr>
    <tr>
      <td><strong>PERSONAL</strong></td>
      <td>PII (Personally Identifiable Information).</td>
    </tr>
    <tr>
      <td><strong>FINANCIAL</strong></td>
      <td>Payment or banking details.</td>
    </tr>
    <tr>
      <td><strong>HIGHLY_SENSITIVE</strong></td>
      <td>SSNs, SINs, or biometrics.</td>
    </tr>
  </tbody>
</table>
