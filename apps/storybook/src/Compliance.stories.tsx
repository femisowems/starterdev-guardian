    ...
    render: () => {
        return (
            <GuardianFormProvider
                ...
                onSubmit={(v) => alert(`Consent Update: ${JSON.stringify(v)}`)}
            >
                <FormLayout
                ...
                >
                    <div className="space-y-4">
                        <div className="p-4 bg-slate-50 rounded-xl border border-slate-200">
                            <h4 className="text-xs font-bold text-slate-800 uppercase mb-4">Processing Purposed</h4>
                            ...
                            <div className="space-y-4">
                                ...
                                <label className="flex items-start gap-3 cursor-pointer group">
                                    <input type="checkbox" defaultChecked className="mt-1 w-4 h-4 rounded border-slate-300 text-indigo-600 focus:ring-indigo-500" />
                                    <div>
                    ...
                    <div className="space-y-4">
                        ...
                        <GuardianFieldLayout label="Reason for Request" name="reason" classification={DataClassification.INTERNAL}>
                            <GuardianField name="reason" label="Reason" classification={DataClassification.INTERNAL}>
                                {({ field }) => <textarea {...field} className="gf-input min-h-[100px]" placeholder="Brief context helps us process your request faster." />}
                            </GuardianField>
                        </GuardianFieldLayout>
                        ...
                        <div className="bg-slate-50 p-4 rounded-xl border border-slate-200">
                            ...
                            <div className="space-y-3">
                                <label className="flex items-center gap-3 cursor-pointer">
                                    <input type="radio" name="purge" defaultChecked className="w-4 h-4 text-indigo-600 focus:ring-indigo-500 border-slate-300" />
                                    <span className="text-xs font-medium text-slate-700">Hard Purge (Irreversibly delete all fields)</span>
                                </label>
                                <label className="flex items-center gap-3 cursor-pointer">
                                    <input type="radio" name="purge" className="w-4 h-4 text-indigo-600 focus:ring-indigo-500 border-slate-300" />
