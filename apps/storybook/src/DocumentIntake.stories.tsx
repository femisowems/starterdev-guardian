        ...
        return (
            ...
            >
                <FormLayout
                    ...
                    description="Securely upload identification documents for automated verification and compliance checking."
                >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <GuardianFieldLayout label="Document Number" name="docNumber" classification={DataClassification.HIGHLY_SENSITIVE}>
                                <GuardianField name="docNumber" label="Doc Number" classification={DataClassification.HIGHLY_SENSITIVE} masked>
                                    {({ field }) => <input {...field} className="gf-input" placeholder="Enter ID number" />}
                                </GuardianField>
                            </GuardianFieldLayout>
                        </div>
                ...
                <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
                    ...
                    <div className="relative font-mono text-sm border border-slate-100 rounded-xl overflow-hidden">
                        ...
                        <div className="p-6 bg-slate-950 text-slate-300 leading-loose">
                            ...
                            <p>Customer Name: {isRedacting ? <span className="bg-slate-700 text-transparent select-none rounded decoration-none">REDACTED_PII</span> : 'Jane S. Doe'}</p>
                            <p>Account ID: {isRedacting ? <span className="bg-slate-700 text-transparent select-none rounded decoration-none">REDACTED_FINANCIAL</span> : '8829-1102-3932'}</p>
                            <p>Mailing Address: {isRedacting ? <span className="bg-slate-700 text-transparent select-none rounded decoration-none">REDACTED_PII</span> : '123 Privacy Lane, Security Heights, CA'}</p>
                            <br />
